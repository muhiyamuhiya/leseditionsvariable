                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open"
                        ...
                        <?php if ($currentUser->role === 'admin'): ?>
                            <a href="/admin" class="flex items-center gap-2 px-4 py-2 text-sm text-indigo-700 font-medium hover:bg-indigo-50">
                                ...
                                Administration
                                <span class="ml-auto text-xs bg-indigo-100 text-indigo-700 px-1.5 py-0.5 rounded">Admin</span>
                            </a>
                        <?php endif; ?>
