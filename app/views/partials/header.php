                ...
                <?php if ($currentUser): ?>
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-100"
                            ...
                            <a href="/mon-compte/achats" class="flex items-center gap-2 px-4 py-2 text-sm <?= str_starts_with($currentPath, '/mon-compte/achats') ? 'text-accent bg-surface-2' : 'text-text-muted hover:text-accent hover:bg-surface-2' ?> transition-colors">
