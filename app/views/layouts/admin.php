...
<!-- Sidebar -->
<aside class="fixed inset-y-0 left-0 w-64 bg-surface border-r border-border z-40 flex flex-col transform transition-transform duration-200 lg:translate-x-0"
    ...
    <nav class="flex-grow overflow-y-auto py-4 px-3 space-y-6 text-sm">
        ...
        function navItem($href, $label, $icon, $uri, $badge = null) {
            ...
            $html = '<a href="' . $href . '" class="flex items-center gap-3 px-3 py-2.5 rounded-r-lg transition-colors ' . $cls . '">';
...
<!-- Contenu principal -->
<div class="flex-grow lg:ml-64 min-h-screen flex flex-col">
    <!-- Header admin -->
    <header class="h-14 bg-surface/80 backdrop-blur border-b border-border flex items-center justify-between px-4 sm:px-6 sticky top-0 z-20">
        <div class="flex items-center gap-3">
            <button @click="sidebarOpen = !sidebarOpen" class="lg:hidden text-text-muted hover:text-white p-1">
