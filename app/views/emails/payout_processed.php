...
$refSafe = htmlspecialchars($reference ?? '', ENT_QUOTES, 'UTF-8');

$title   = 'Versement effectué';
$preview = "Tes {$amountFmt} USD ont été envoyés via {$methodLabel}.";
...
<p class="text-muted" style="margin:0 0 24px 0;font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:1.6;color:#525866;">
    Ton versement a été envoyé. Vérifie ton compte <?= htmlspecialchars($methodLabel, ENT_QUOTES, 'UTF-8') ?> dans les prochaines minutes.
</p>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#0B0B0F;border-radius:12px;margin:0 0 24px 0;">
    <tr><td style="padding:24px 28px;font-family:'Helvetica Neue',Arial,sans-serif;">
        <p style="margin:0 0 4px 0;font-size:11px;letter-spacing:1.5px;text-transform:uppercase;color:#A0A0B0;font-weight:600;">Montant versé</p>
        <p style="margin:0 0 12px 0;font-size:32px;font-weight:700;color:#F59E0B;letter-spacing:-0.5px;"><?= $amountFmt ?> USD</p>
        <p style="margin:0;font-size:13px;color:#A0A0B0;">Méthode : <?= htmlspecialchars($methodLabel, ENT_QUOTES, 'UTF-8') ?></p>
    </td></tr>
</table>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#FAF7F2;border-radius:10px;border:1px solid #EBE6DD;margin:0 0 24px 0;">
    <tr><td style="padding:14px 22px;font-family:'Helvetica Neue',Arial,sans-serif;font-size:13px;line-height:1.6;color:#525866;">
        <strong>Référence :</strong> <span style="font-family:'SF Mono',Menlo,monospace;font-size:12px;color:#0B0B0F;"><?= $refSafe ?></span>
    </td></tr>
</table>
<?php endif; ?>
...
<p class="text-muted" style="margin:24px 0 0 0;font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:1.6;color:#525866;">
    Si tu ne vois rien arriver d'ici 48h, réponds à cet email avec la référence ci-dessus, on creuse.
</p>
<?php
