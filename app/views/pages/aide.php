...
$categories = [
    ...
    'auteurs' => [
        ...
        'faqs'  => [
            ...
            ['Combien je gagne par vente ?', "80% du prix de vente sur chaque achat unitaire. Sur un livre vendu 9,99 USD, tu touches environ 7,67 USD net après frais de paiement. Pour les lectures via abonnement, on calcule un pool mensuel redistribué au prorata des pages réellement lues."],
            ['Quand suis-je payé ?', "Versements mensuels, dès 20 USD de revenus accumulés. Le 5 du mois suivant. Mobile Money (RDC, Sénégal, etc.), virement SWIFT pour la diaspora, ou compte Stripe Connect."],
