        ...
        <tr class="border-b border-border/30 hover:bg-surface-2/50">
            ...
            <td class="py-3 px-2">
                <div class="flex items-center gap-2">
                    <a href="/admin/livres/<?= e($l->slug) ?>/preview" class="text-accent hover:text-accent-hover text-xs font-medium"><?= in_array($l->statut, ['brouillon','en_revue']) ? 'Examiner' : 'Aperçu' ?></a>
